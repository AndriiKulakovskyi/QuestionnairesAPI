"""
AUTOQ_PSQI - AUTOQ_PSQI Questionnaire
=====================================
...
@register_questionnaire("AUTOQ_PSQI")
@dataclass
class AutoqPsqi(BaseQuestionnaire):
    """AUTOQ_PSQI Questionnaire - reusable across applications."""
    
    def __init__(self):
        """Initialize AUTOQ_PSQI questionnaire with all 14 items."""
