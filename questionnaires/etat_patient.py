"""
ETAT_PATIENT - ETAT_PATIENT Questionnaire
=========================================
...
@register_questionnaire("ETAT_PATIENT")
@dataclass
class EtatPatient(BaseQuestionnaire):
    """ETAT_PATIENT Questionnaire - reusable across applications."""
    
    def __init__(self):
        """Initialize ETAT_PATIENT questionnaire with all 33 items."""
        ...
        questions_list = [
            ...
            Question(
                id='etat6',
                text="Perte ou gain de poids?",
                options=[
                    AnswerOption(value='a', label="Perte de poids", score=0),
                    AnswerOption(value='b', label="Gain de poids", score=1),
                    AnswerOption(value='c', label="ne sais pas", score=2)
                ],
                question_type=QuestionType.SINGLE_CHOICE
            ),
            ...
            Question(
                ...
                text="Insomnie ou hypersomnie?",
                options=[
                    AnswerOption(value='a', label="Insomnie", score=0),
                    AnswerOption(value='b', label="hypersomnie", score=1),
                    AnswerOption(value='c', label="Ne sais pas", score=2)
                ],
                question_type=QuestionType.SINGLE_CHOICE
            ),
            Question(
                id='etat_epi_man_psycho',
        ...
        super().__init__(
            code="ETAT_PATIENT",
            name="ETAT_PATIENT Questionnaire",
