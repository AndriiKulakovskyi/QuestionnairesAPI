...
@register_questionnaire("HAM_ANX")
@dataclass
class HamAnx(BaseQuestionnaire):
    """HAM_ANX Questionnaire - reusable across applications."""
    
    def __init__(self):
        """Initialize HAM_ANX questionnaire with all 5 items."""
