"""
HAM_DEPRES - HAM_DEPRES Questionnaire
=====================================
...
@register_questionnaire("HAM_DEPRES")
@dataclass
class HamDepres(BaseQuestionnaire):
    """HAM_DEPRES Questionnaire - reusable across applications."""
    
    def __init__(self):
        """Initialize HAM_DEPRES questionnaire with all 18 items."""
