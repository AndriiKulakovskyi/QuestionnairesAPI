"""
HETERO_MADRS - HETERO_MADRS Questionnaire
=========================================
...
@register_questionnaire("HETERO_MADRS")
@dataclass
class HeteroMadrs(BaseQuestionnaire):
    """HETERO_MADRS Questionnaire - reusable across applications."""
    
    def __init__(self):
        """Initialize HETERO_MADRS questionnaire with all 9 items."""
        ...
        questions_list = [
            ...
            Question(
                ...
                options=[
                    AnswerOption(value='a', label="0 0 Pas de pensée pessimiste.", score=0),
                    AnswerOption(value='b', label="1", score=1),
        ...
        super().__init__(
            code="HETERO_MADRS",
            name="HETERO_MADRS Questionnaire",
