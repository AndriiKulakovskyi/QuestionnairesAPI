"""
INCLUSION - INCLUSION Questionnaire
===================================
...
@register_questionnaire("INCLUSION")
@dataclass
class Inclusion(BaseQuestionnaire):
    """INCLUSION Questionnaire - reusable across applications."""
    
    def __init__(self):
        """Initialize INCLUSION questionnaire with all 7 items."""
        
        questions_list = [
            Question(
                id='epi_depress_caract',
                text="Episode dépressif caractérisé",
                options=[
            ...
            Question(
                id='trou_compul',
                text="Trouble obsessionel compulsif",
                options=[
                    AnswerOption(value='a', label="Oui", score=0),
                    AnswerOption(value='b', label="Non", score=1)
                ],
