...
@register_questionnaire("MARS")
@dataclass
class Mars(BaseQuestionnaire):
    """MARS Questionnaire - reusable across applications."""
    
    def __init__(self):
        """Initialize MARS questionnaire with all 10 items."""
