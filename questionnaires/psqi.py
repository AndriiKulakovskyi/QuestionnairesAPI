...
@register_questionnaire("PSQI")
@dataclass
class Psqi(BaseQuestionnaire):
    """PSQI Questionnaire - reusable across applications."""
    
    def __init__(self):
        """Initialize PSQI questionnaire with all 15 items."""
        ...
        questions_list = [
            ...
            Question(
                id='psqi11e',
                text="e. Autres types d’agitation pendant votre sommeil",
                options=[
                    AnswerOption(value='a', label="Jamais au cours des 30 derniers jours", score=0),
                    AnswerOption(value='b', label="Moins d’une fois par semaine", score=1),
                    AnswerOption(value='c', label="Une ou deux fois par semaine", score=2),
            ...
            Question(
                id='psqi5j',
                text="j. Vous avez eu des difficultés à dormir pour d’autres raisons, ",
                options=[
                    AnswerOption(value='a', label="Jamais au cours des 30 derniers jours", score=0),
                    AnswerOption(value='b', label="Moins d’une fois par semaine", score=1),
                    AnswerOption(value='c', label="Une ou deux fois par semaine", score=2),
